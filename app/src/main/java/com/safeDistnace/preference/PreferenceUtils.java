...
package com.safeDistnace.preference;
...
import com.safeDistnace.CameraSource;
import com.safeDistnace.CameraSource.SizePair;
...
public class PreferenceUtils {
  ...
  public static void setSafeDistanceUOM(Context context, String safeDistanceUOM) {
    SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    String prefKey = context.getString(R.string.pref_key_safe_distance_uom);
    SharedPreferences.Editor editor = sharedPreferences.edit();
    editor.putString(prefKey, safeDistanceUOM);
    editor.apply();
  }
